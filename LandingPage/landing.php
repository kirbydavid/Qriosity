  ...
  <body>
    ...
    <div class="Content">
      <div class="Container" id="page1">
        <div id="pg1BG"></div>
        <div id="ContentPage1">
          <h1 id="text">Scan your QRIOSITIES away</h1>
          <p>
            QRiosity helps users check their food by providing vital
            informations including ingredients, date of creation and more.
          </p>
          <button id="Generate"><a> Generate QR Now!</a></button>
        </div>
        <!-- Login Form Pop-up -->
